...
formación ferroviaria, y tendrá un presupuesto preliminar estimado de 670 hs de trabajo y \$60.000, con 
...
\item Planificación del proyecto \hfill (subtotal 20 hs)
  ...
  \end{enumerate}
\item Investigación preliminar \hfill (subtotal 60 hs)
  \begin{enumerate}
  ...
  \item Estudio de la normativa \hfill (20 hs)
  \end{enumerate}
\item Desarrollo del software \hfill (subtotal 305 hs)
  \begin{enumerate}
  ...
  \item Pruebas y verificación del software \hfill (40 hs)
