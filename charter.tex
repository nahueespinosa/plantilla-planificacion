...
formación ferroviaria, y tendrá un presupuesto preliminar estimado de 630 hs de trabajo y \$55.000, con 
...
\begin{ganttchart}[
  ...
  \ganttgroup{Desarrollo del software}{2020-07-27}{2021-01-31} \\
    \ganttbar{3.1 Elaboración del plan de garantía de calidad del software}{2020-07-27}{2020-08-02} \\
    \ganttlink{elem5}{elem7}
    \ganttlinkedbar{3.2 Especificación de requisitos del software}{2020-08-03}{2020-08-09} \\
    \ganttlinkedbar{3.3 Especificación de arquitectura del software}{2020-08-10}{2020-08-23} \\
    \ganttlinkedbar{3.4 Elaboración del plan de verificación del software}{2020-08-24}{2020-08-30} \\
    \ganttlinkedbar{3.5 Elaboración del plan de validación del software}{2020-08-31}{2020-09-06} \\
    \ganttlinkedbar{3.6 Selección y configuración del entorno de desarrollo}{2020-09-07}{2020-09-13} \\
    \ganttlinkedbar{3.7 Selección de librerías externas}{2020-09-14}{2020-09-20} \\
    \ganttlinkedbar{3.8 Implementación de drivers y primitivas}{2020-09-21}{2020-10-04} \\
    \ganttlinkedbar{3.9 Implementación de módulo de interfaz ...}{2020-10-05}{2020-10-18} \\  
    \ganttlinkedbar[
      bar inline label anchor={west}, bar inline label node/.append style={left=2mm}  % Etiqueta a la izquierda
    ]{3.10 Implementación de módulo de medición de v...}{2020-10-19}{2020-11-15} \\
    \ganttlinkedbar[
      bar inline label anchor={west}, bar inline label node/.append style={left=2mm}  % Etiqueta a la izquierda
    ]{3.11 Implementación de módulo de comunicación y localización}{2020-11-16}{2020-12-20} \\
    \ganttlinkedbar[
      bar inline label anchor={west}, bar inline label node/.append style={left=2mm}  % Etiqueta a la izquierda
    ]{3.12 Implementación de módulo de lógica principal}{2020-12-21}{2021-01-17} \\
    \ganttlinkedbar[
      bar inline label anchor={west}, bar inline label node/.append style={left=2mm}  % Etiqueta a la izquierda
    ]{3.13 Pruebas y verificación del software}{2021-01-18}{2021-01-26} \\
    \ganttlinkedbar[
      bar inline label anchor={west}, bar inline label node/.append style={left=2mm}  % Etiqueta a la izquierda
    ]{3.14 Elaboración de informe de verificación}{2021-01-27}{2021-01-31}
\end{ganttchart}
\end{center}
