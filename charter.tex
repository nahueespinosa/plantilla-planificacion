...
\begin{table}[!htpb]
  ...
  \multirow{-3}{*}{\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}c@{}}WBS\end{tabular}} &
    ...
    3.8 & Implementación de drivers y primitivas & P & & & & & \\ \hline
    3.9 & Implementación de módulo de interfaz humano-máquina & P & & & & & \\ \hline
    3.10 & Implementación de módulo de medición de velocidad & P & & & & & \\ \hline
    3.11 & Implementación de módulo de comunicación y localización & P & & & & & \\ \hline
    3.12 & Implementación de módulo de lógica principal & P & & & & & \\ \hline
