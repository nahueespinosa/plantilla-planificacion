...
\item Diseño del firmware del sistema utilizando herramientas y metodologías vistas en la Carrera de Especialización
en Sistemas Embebidos.
\item Documentación del proceso de diseño y desarrollo del firmware como propone la norma UNE-EN 50128. 
\item Diseño de la placa principal del hardware reemplazando la EDU-CIAA-NXP por un procesador ad-hoc.
...
\begin{itemize}
\item El análisis, la definición de subsistemas, interacciones y uso de patrones de diseño en el prototipo sigue siendo
válido para la segunda iteración del proyecto.
