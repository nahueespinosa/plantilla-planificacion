...
formación ferroviaria, y tendrá un presupuesto preliminar estimado de 650 hs de trabajo y \textcolor{red}{\$XXX}, con 
...
\multirow{2}{*}{Colaboradores} & Dr. Ing. Ariel Lutenberg & CONICET-GICSAFe & \shortstack[l]{Director Grupo	de \\ Investigación} \\ \cline{2-4}
& Ing. Sergio Dieleke & - & \shortstack[l]{Jefe de Laboratorio \\ Electrónico de \\ Material Rodante} \\ \hline
\multirow{2}{*}{Orientadores} & \supname & \pertesupname & \shortstack[l]{Director Trabajo \\ Final} \\ \cline{2-4} 
& \cosupname & \pertecosupname &\shortstack[l]{Codirector Trabajo \\ Final} \\ \hline
\end{tabularx}
\end{table}
...
Estos requerimientos fueron obtenidos a partir de los documentos ''R\_DCP\_10 Definición Conceptual del Proyecto - Fase 1'' 
y ''R\_DRQ\_10 Distribución de los requisitos del sistema - Fase 5''. Los mismos fueron creados originalmente por el Ing. 
Ivan Di Vito siguiendo la recomendación de la norma UNE-EN 50126 como resultado de múltiples reuniones con las diferentes 
partes interesadas en la realización del proyecto. 
...
\item Grupo de requerimientos asociados con la interfaz humano-máquina
  \begin{enumerate}
    \item La interfaz debe contar con una llave rotativa precintable para activar el modo aislado limitado.
    \item La interfaz debe indicar el modo actual del sistema (modo aislado o modo normal).
    \item La interfaz debe mostrar la velocidad media del equipo en km/h (3 ó 4 dígitos).
    \item La interfaz debe indicar el estado de las señales de corte de tracción y freno de emergencia.
    \item La interfaz debe indicar la presencia de un comando remoto de la central operativa.
    \item La interfaz debe indicar el estado de los módulos GPS.
  \end{enumerate}
...
\item Grupo de requisitos asociados a la comunicación con la central operativa
  \begin{enumerate}
    \item El sistema debe informar periódicamente (con un tiempo configurable) su estado a la central operativa a través de la red de datos GPRS, 3G ó 4G.
    \item El sistema debe utilizar la antena GPRS/GPS ya disponible en la formación.
    ...
    \item El sistema debe ser capaz de recibir un comando remoto que cancele cualquier comando remoto vigente (exit). 
...
\item Grupo de requerimientos asociados al modo normal de funcionamiento
  \begin{enumerate}
  \item EL modo normal no debe intervenir en el funcionamiento del material rodante (prioridad alta).
...
\item Grupo de requerimientos asociados al modo aislado limitado
  \begin{enumerate}
  \item En modo aislado limitado el sistema debe evitar la aplicación del corte de tracción y/o freno de emergencia por parte de los subsistemas de seguridad del material rodante.
...
\item Grupo de requerimientos asociados al hardware y al gabinete
  \begin{enumerate}
    \item El sistema debe utilizar la alimentación presente en el material rodante compredida entre 72 V y 100 V.
...
\begin{enumerate}
\item Planificación del proyecto \hfill (total 20 hs)
  \begin{enumerate}
  \item Elaboración del plan de proyecto \hfill (20 hs)
  \end{enumerate}
\item Investigación preliminar \hfill (total 90 hs)
  \begin{enumerate}
  ...
  \end{enumerate}
\item Desarrollo del firmware \hfill (total 290 hs)
  \begin{enumerate}
  ...
  \end{enumerate}
\item Desarrollo del hardware \hfill (total 130 hs)
  \begin{enumerate}
  ...
  \end{enumerate}
\item Integración del sistema \hfill (total 70 hs)
  \begin{enumerate}
  ...
  \end{enumerate}
\item Procesos de finalización \hfill (total 60 hs)
  \begin{enumerate}
