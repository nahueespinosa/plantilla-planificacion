...
\item Grupo de requerimientos asociados al modo normal de funcionamiento
  \begin{enumerate}
  \item No debe intervenir en el funcionamiento del material rodante.
...
\item Grupo de requerimientos asociados al modo aislado limitado
  ...
  \begin{enumerate}
    ...
    \item Si se supera una determinada velocidad configurable, debe activar el corte de tracción y si se supera otra velocidad mayor debe activar el freno de emergencia.
    \item Si se supera una determinada velocidad configurable, debe emitir una señal sonora intermitente a través de un buzzer.
    \item Una vez aplicado, el corte de tracción debe dejar de aplicarse si la velocidad vuelve a ser menor a una velocidad configurable. 
    \item Una vez aplicado, el freno de emergencia sólo debe dejar de aplicarse luego de un tiempo configurable desde que se superó el límite.
...
\item Grupo de requerimientos asociados con las comunicaciones
  \begin{enumerate}
    ...
    \item Debe informar periódicamente el estado del sistema a la central operativa a través de la red de datos GPRS.
    ...
    \item Si no recibe un nuevo comando remoto luego de un tiempo configurable, debe volver al algoritmo de activación de corte de tracción y freno de emergencia por defecto.
...
\item Grupo de requerimientos asociados al hardware y al gabinete
  \begin{enumerate}
    ...
    \item El gabinete debe tener grado de seguridad IP66 o superior (protección contra polvo e inmersión completa en agua).
  \end{enumerate}
\end{enumerate}
